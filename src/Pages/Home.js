    ...
    <div className="Homepage">
      <div className="hp-promotion-image">
        ...
        <div className="centered-text">
          Lift like the legends in authentic bodybuilding cuts.
        </div>
        ...
        <img
          className="sub-image"
          src="https://my-ec-react.s3-ap-southeast-2.amazonaws.com/product-photos/hp-photo-3.JPG"
          alt="hp-top"
        />
        <img
          className="mobile-sub-image"
          src="https://my-ec-react.s3-ap-southeast-2.amazonaws.com/product-photos/hp-photo-3-mobile.JPG"
          alt="hp-top"
        />
      </div>
      <div>
        <Row className="hp-new-release">
          ...
          <Col className="ml-auto">
            <p className="view-all-link" onClick={() => history.push("/all")}>
              View All
            </p>
          </Col>
        </Row>
